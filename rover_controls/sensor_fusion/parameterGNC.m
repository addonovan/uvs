...
%%%%%%%%%%%%%%%%%%% control parameter %%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1:speed, 2:angle
KP1=15; %20;    % 1 is velocity controller
KP2=100;%3;%10;  %7 ->   % 2 is angle controller

KI1=0.5;%10;%0.3; %0.0010.5 %0.001;%10;
KI2=10; %0.1 %0.001; %0.001;%1; % 3 ->
...
%%%%%%%%%%%%%%%%%% Way Points %%%%%%%%%%%%%%%%%%%%%%%%%%%
% Y_array  = [-2 2 0 ]; %test square
% X_array  = [3 6 9 ]; 

%  X_array  = [4 6 10];   %Competition Points
%  Y_array  = [0 3 1];  
 
 Y_array  = [0 1 1 0];    %Test case
 X_array  = [1 1 0 0];